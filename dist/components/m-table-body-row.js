  ...
  (0, _createClass2['default'])(MTableBodyRow, [
        ...
        var mapArr = this.props.columns
          ...
          .map(function (columnDef, index) {
            ...
            if (
              ...
              var isEditable =
                columnDef.editable !== 'never' && !!_this2.props.cellEditable;

              if (isEditable && _this2.props.cellEditable.isCellEditable) {
                isEditable = _this2.props.cellEditable.isCellEditable(
                  _this2.props.data,
                  columnDef
                );
              }
              ...
              var key = 'cell-'
                .concat(_this2.props.data.tableData.id, '-')
    ...
    },
    {
      ...
      value: function renderActions() {
        ...
        var width = this.props.actionsColumnWidth;
        return /*#__PURE__*/ _react['default'].createElement(
          _TableCell['default'],
          {
            size: size,
